...
## V/C Ratio AM (2019 and 2050)

```{r plot directional am vc}

network_links_19_vc <- network_links_19 %>%  
  select(A, B, DISTANCE, RT_TYPE, DIR_LANE, TOT_LANE, VCAM, VCPM, DIR_V) %>% 
  arrange(DIR_V)

network_links_50_vc <- network_links_50 %>%  
  select(A, B, DISTANCE, RT_TYPE, DIR_LANE, TOT_LANE, VCAM, VCPM, DIR_V) %>% 
  arrange(DIR_V)

make_2_maps(network_links_19_vc, network_links_50_vc, "VCAM", "VCAM", "V/C AM 2019", "V/C AM 2050")

```


## V/C Ratio PM (2019 and 2050)

```{r plot directional pm vc}


make_2_maps(network_links_19_vc, network_links_50_vc, "VCPM", "VCPM", "V/C PM 2019", "V/C PM 2050")
